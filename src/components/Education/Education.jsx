    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        {myeducation.map((edu) => (
          <div
            key={edu.id}
            className="bg-[#0f0e17] border border-white/10 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] rounded-2xl overflow-hidden transition-transform transform hover:scale-[1.02]"
          >
            {/* Top Apple-style bar */}
