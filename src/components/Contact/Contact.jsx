...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="flex flex-col items-center justify-center py-20 px-[7vw] lg:px-[10vw] font-sans bg-[#0a0918]"
    >
      <ToastContainer />
...
{`\n  `}
<span className="text-green-400">📧 email</span>: <span className="text-yellow-300 break-words">"biswaranjanbehera006@gmail.com"</span>,
{`\n  `}
